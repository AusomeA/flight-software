...
═══ ~/projects/vsat/LICENSE — NEW file, no extension ═══

Copyright (c) 2026 Austin Anderson. All rights reserved.

This source code is made publicly viewable for portfolio and evaluation purposes only.

No permission is granted to use, copy, modify, merge, publish, distribute,
sublicense, or sell this software or any portion of it, in source or binary
form, without prior written permission from the copyright holder.

For licensing inquiries, contact: RedlineAnderson@Gmail.com
